...
def main(config, resume):
    ...
    data_loader = get_instance(module_loaders, 'data_loader', config)
    ...
    loss = getattr(module_model, config['model']['loss'])
    metrics = [getattr(module_model, met) for met in config['model']['metrics']]
